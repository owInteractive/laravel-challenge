...
header("Content-Disposition: attachment; filename=\"fazendo_eventos.csv\"");
...
outputCSV(array(
    array('Contador', 'Evento', 'Titulo', 'Descr', 'Inicio', 'Fim'),
		...
		$busca2 = $pdo->prepare("SELECT * FROM eventos WHERE usu = :usuqui AND comeco > :min");
		
		$busca2->bindValue("usuqui", $id_usu);
