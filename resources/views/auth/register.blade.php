        ...
        <div class="flex justify-center content-center flex-wrap min-h-screen h-full">
            ...
            <div class="w-full max-w-md">
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <h2 class="mb-4 text-2xl text-gray-700">Register</h2>
                    ...
                    <form method="post" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   id="name" name="name" required placeholder="Name" value="{{ old('name') }}">
                            @if($errors->has('name'))
                        ...
                        <div class="inline-block float-left">
                            <button class="py-2 px-3 bg-blue-800 text-white rounded">Register</button>
                        </div>
