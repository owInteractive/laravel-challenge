...
<div class="pl-3 pt-4">
  <span class="h3">Novo Evento</span>
</div>

{!! Form::open(['id'=>'formAddEvent', 'route'=>['event.store'], 'method'=>'post']) !!}
...
<div class="form-group col-12 pt-3 row">
        ...
        <div class="col-5 pt-3">
            ...
            {!! Form::text('ts_start', null, ['class'=>'form-control','id' => 'ts_start', 'autocomplete' => 'off']) !!}
        ...
        <div class="col-4 pt-3">
            ...
            {!! Form::text('time_start', null, ['class'=>'form-control','id' => 'time_start', 'autocomplete' => 'off']) !!}
        ...
        <div class="col-4 pt-3">
            ...
            {!! Form::text('time_end', null, ['class'=>'form-control','id' => 'time_end', 'autocomplete' => 'off']) !!}
