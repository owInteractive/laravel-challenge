                ...
                <form action="{{ route('event.store') }}" method="post">
                    {{ csrf_field() }}
                        <div class="form-group text-center">
                            ...
                            <input type="text" class="form-control  text-center"  name="titulo">
                        </div>
                        <div class="form-group text-center">
                            ...
                            <div class="row">
                                    <div class="form-group col-md-6 text-center">
                                            ...
                                            <input type="text" id="datepicker" class="form-control text-center" name="dataInicio"/>
                                        </div>
                                        <div class="form-group col-md-6 text-center">
                                                <label class="label-control">Data Fim</label>
                                                <input type="text" id="datepicker1" class="form-control text-center" name="dataFim"/>
                                         </div>
                            </div>
                            <br>
