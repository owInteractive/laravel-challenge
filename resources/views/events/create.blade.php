    ...
    <div class="card">
        <form action="{{ route('events.store') }}"
            ...
            <div class="header">
                ...
                <h2><strong>@lang('system.text.create_event')</strong></h2>
            </div>
            <div class="body">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            <input class="form-control datetimepicker {{ $errors->has('start_at') ? 'is-invalid' : '' }}"
                                   ...
                                   value="{{ old('start_at') ?: date('Y-m-d H:i') }}"
                                   name="start_at" />
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            <input class="form-control datetimepicker {{ $errors->has('end_at') ? 'is-invalid' : '' }}"
                                   ...
                                   value="{{ old('end_at') ?: date('Y-m-d H:i') }}"
                                   name="end_at" />
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="form-group">
                            <textarea class="form-control {{ $errors->has('end_at') ? 'is-invalid' : '' }}"
                                      ...
                                      id="description"
                                      rows="10"
                                      placeholder="@lang('system.text.description')">{{ old('description') }}</textarea>
