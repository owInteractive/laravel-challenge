                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('events.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 {{ $errors->has('start_at') ? 'has-error' : '' }}">
                                    <input class="form-control" type="datetime-local" name="start_at" value="{{ old('start_at') ? \Carbon\Carbon::parse(old('start_at'))->format('Y-m-d\TH:i') : '' }}">
                                ...
                                <div class="col-md-4 {{ $errors->has('end_at') ? 'has-error' : '' }}">
                                    <input class="form-control" type="datetime-local" name="end_at" value="{{ old('end_at') ? \Carbon\Carbon::parse(old('end_at'))->format('Y-m-d\TH:i') : '' }}">
