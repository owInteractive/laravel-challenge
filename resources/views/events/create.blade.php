@extends('layouts.app', ['activePage' => 'event', 'titlePage' => __('User Management')])
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('start_at') ? ' has-danger' : '' }}">
                      <input class="date_time form-control{{ $errors->has('start_at') ? ' is-invalid' : '' }}" name="start_at" id="input-start_at" type="text" placeholder="{{ __('00/00/0000 00:00:00')}}" value="{{ old('start_at') }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('end_at') ? ' has-danger' : '' }}">
                      <input class="date_time form-control{{ $errors->has('end_at') ? ' is-invalid' : '' }}" name="end_at" id="input-end_at" type="text" placeholder="{{ __('00/00/0000 00:00:00') }}" value="{{ old('end_at') }}" required />
